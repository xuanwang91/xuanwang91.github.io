...
3. Seed-guided NER on **9 new entity types related to COVID-19 studies**: our novel weakly-supervised NER method only requiring several human-input seeds for each new type.
...
We reorganized all the entity types from the 4 sources and merged into one entity type hierarchy with **74 fine-grained entity types** for annotation. The entity type hierarchy (**CORD-19-types.xlsx**) used in CORD-19-NER can be found in our dataset.
