...
The CORD-19-NER annotated dataset can be downloaded [here](https://uofi.box.com/s/264am0gt6komv0nz0edamyd92zy2h1db). It includes a tokenized corpus (**CORD-19-corpus.json**) and the entity annotation results (**CORD-19-ner.json**). The corpus is generated from the 29,500 documents in [COVID-19 Open Research Dataset Challenge (CORD-19)](https://www.kaggle.com/allen-institute-for-ai/CORD-19-research-challenge) corpus (2020-03-13). A detailed description of the file schemas can be found in the **README** file.
