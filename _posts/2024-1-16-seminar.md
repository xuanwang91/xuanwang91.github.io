...
- **Presenter** (1-2 students): Create the main presentation for around 30 min, describing the motivation, problem definition, method, and experimental findings of this paper.
...
## Course Schedule
This is a tentative lecture schedule. Please check the schedule on Canvas for recent updates.
...
| 01/31 (Wed) | Do Language Models Know When They’re Hallucinating References? |  
| 02/05 (Mon) | RARR: Researching and Revising What Language Models Say, Using Language Models |  
| 02/07 (Wed) | The Internal State of an LLM Knows When It’s Lying |  
| 02/12 (Mon) | SELFCHECKGPT: Zero-Resource Black-Box Hallucination Detection for Generative Large Language Models | 
| 02/14 (Wed) | Measuring Reliability of Large Language Models through Semantic Consistency | 
| **Confidence** |
| 02/19 (Mon) | GENERATING WITH CONFIDENCE: UNCERTAINTY QUANTIFICATION FOR BLACK-BOX LARGE LANGUAGE MODELS | 
| 02/21 (Wed) | SEMANTIC UNCERTAINTY: LINGUISTIC INVARIANCES FOR UNCERTAINTY ESTIMATION IN NATURAL LANGUAGE GENERATION |  
| 02/26 (Mon) | Just Ask for Calibration: Strategies for Eliciting Calibrated Confidence Scores from Language Models Fine-Tuned with Human Feedback |  
| 02/28 (Wed) | Teaching models to express their uncertainty in words |  
| 03/04 (Mon) | **Spring Break (No Class)** | 
| 03/06 (Wed) | **Spring Break (No Class)** |  
| 03/11 (Mon) | Reducing conversational agents’ overconfidence through linguistic calibration | 
| **Explainability** |
| 03/13 (Wed) | Studying Large Language Model Generalization with Influence Functions |
| 03/18 (Mon) | Understanding Black-box Predictions via Influence Functions |  
| 03/20 (Wed) | Estimating Training Data Influence by Tracing Gradient Descent | 
| 03/25 (Mon) | Representer Point Selection for Explaining Deep Neural Networks |
| 03/27 (Wed) | Axiomatic Attribution for Deep Networks |  
| 04/01 (Mon) | The Explanation Game: Explaining Machine Learning Models Using Shapley Values |  
| 04/03 (Wed) | Influence Patterns for Explaining Information Flow in BERT |  
