...
| 01/24 (Wed) | Applied Math and Machine Learning Basics |  
| 01/29 (Mon) | Applied Math and Machine Learning Basics |  
| 01/31 (Wed) | Deep Feedforward Networks |  
| 02/05 (Mon) | Deep Feedforward Networks |  
| 02/07 (Wed) | Regularization for Deep Learning |  
| 02/12 (Mon) | Regularization for Deep Learning | 
| 02/14 (Wed) | Optimization for Deep Learning | 
| 02/19 (Mon) | Optimization for Deep Learning | 
| 02/21 (Wed) | Convolutional Networks |  
| 02/26 (Mon) | Convolutional Networks |  
| 02/28 (Wed) | Recurrent and Recursive Networks |  
| 03/04 (Mon) | Spring Break (No Class) | 
| 03/06 (Wed) | Spring Break (No Class) |  
| 03/11 (Mon) |  |  
| 03/13 (Wed) | Practical Methodology for Deep Learning |
| 03/18 (Mon) | Practical Methodology for Deep Learning |  
| 03/20 (Wed) | Autoencoders | 
| 03/25 (Mon) | Autoencoders |
| 03/27 (Wed) | Representation Learning |  
| 04/01 (Mon) | Representation Learning |  
| 04/03 (Wed) | Structured Probabilistic Models |  
| 04/08 (Mon) | Structured Probabilistic Models | 
| 04/10 (Wed) | Deep Generative Models |  
| 04/15 (Mon) | Deep Generative Models | 
| 04/17 (Wed) | Deep Reinforcement Learning |  
| 04/22 (Mon) | Deep Reinforcement Learning |  
| 04/24 (Wed) | Applications (CV, NLP, etc.) |  
| 04/29 (Mon) | Applications (CV, NLP, etc.) | 
| 05/01 (Wed) | Societal Impacts and Ethics |  
